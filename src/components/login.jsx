...
const slides = [
  {
    ...
    description:
      "Rejoignez notre communauté grandissante et bénéficiez d'une expérience postale collaborative et moderne.",
  },
  {
    icon: MessageSquare,
    title: "Feedback Immédiat",
    description:
      "Permet de suivre l'engagement des clients et associer chaque action à un employé.",
  },
  {
    icon: BarChart2,
    title: "Satisfaction Client",
    description:
      "Permet de surveiller la satisfaction des clients en temps réel.",
  },
];
      ...
      <div className="flex items-center justify-center p-8">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full bg-[#003DA5] hover:bg-[#002d7a]"
            >
